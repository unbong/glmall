...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void up(Long spuId) {
        ...
        try {
            ...
            R r = wareFeignService.getHasStock(longList);
        ...
        List<SkuEsModel> uoProducts = skus.stream().map(item -> {
                    ...
                    // TODO: 2021/8/15 热度评分 0
                    esModel.setHotScore(0L);
                    // TODO: 2021/8/15   查询品牌和分类的名字信息
        ...
        // TODO: 2021/8/15  将数据发送给检索服务

        R r = searchFeignService.saveProduct(uoProducts);
